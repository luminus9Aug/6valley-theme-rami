                            ...
                            <div class="col-lg-6 mb-5 mb-lg-0">
                                ...
                                <div class="d-flex justify-content-center">
                                    <img width="283" class="dark-support"
                                         src="{{ theme_asset('assets/img/forget-pass/verification.png') }}"
                                         alt="{{translate('image')}}">
                                </div>
                            </div>
                            <div class="col-lg-6 text-center">
                                <div class="d-flex justify-content-center mb-3">
                                    <img width="50" class="dark-support"
                                         src="{{ theme_asset('assets/img/forget-pass/verification-icon.png') }}"
                                         alt="{{translate('image')}}">
                                </div>
                                ...
                                >
                                    ...
                                    <div class="d-flex justify-content-center gap-3 mt-3">
                                        ...
                                        <button class="btn btn-primary px-sm-5 submitVerifyForm" type="button">
                                            {{ translate('verify') }}
                                        </button>
                                    </div>
                                </form>
