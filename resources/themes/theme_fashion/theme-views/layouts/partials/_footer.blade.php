                        ...
                        <div class="footer-top-wrapper flex-column">
                            ...
                            <div class="content line-limit w-100">
                                ...
                                <span class="get-view-by-onclick link-primary cursor-pointer"
                                      data-link="{{route('about-us')}}">{{ translate('read_more') }}
                                </span>
                            </div>
                        </div>
                        <div class="footer-address">
                            ...
                            <div class="footer-address-card d-flex gap-3">
                                ...
                                <div>
                                    ...
                                    <a class="text-dark" href="mailto:{{ $web_config['email'] }}">{{ $web_config['email'] }}</a>
                                </div>
                            </div>
                            <div class="footer-address-card d-flex gap-3">
                                ...
                                <div>
                                    ...
                                    <div><a href="tel:{{ $web_config['phone'] }}" class="text-dark direction-ltr">{{ $web_config['phone'] }}</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="footer-bottom-wrapper text-capitalize">
                                ...
                                <div class="footer-widget ">
                                    ...
                                    <ul class="links">
                                        ...
                                        <li>
                                            <a href="{{route('vendor.auth.registration.index')}}">{{ translate('sell_on') }} {{ $web_config['company_name'] }}</a>
                                        </li>
                                        @endif
                                        ...
                                        @if(isset($web_config['shipping_policy']['status']) && $web_config['shipping_policy']['status'] == 1)
                                            <li>
                                                <a href="{{route('shipping-policy')}}">{{translate('shipping_policy')}}</a>
                                            </li>
                                        @endif
                                ...
                                <div class="footer-widget">
                                    ...
                                    <ul class="links">
                                        <li>
                                            @if(auth('customer')->check())
                                                <a href="{{ route('chat', ['type' => 'vendor'])}}">{{ translate('live_chat') }}</a>
                                            @else
