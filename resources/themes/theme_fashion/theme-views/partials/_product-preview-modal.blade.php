<div class="modal fade" id="product-preview-modal" tabindex="-1"
     aria-labelledby="productPreviewModalLabel"
     aria-hidden="true">
    ...
    ($previewFileInfo['mime_category'] == 'document' && $previewFileInfo['mime_type'] == 'application/pdf') ? '' : 'd-none'
                ...
                <h6 class="modal-title text-truncate fs-14 fw-semibold">{{ $product->name }}</h6>
