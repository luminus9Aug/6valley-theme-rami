(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(".recommended-next").on("click", function () {
            $(this).closest('section').find(".recommended-slider").trigger("next.owl.carousel", [600]);
        });
        $(".recommended-prev").on("click", function () {
            $(this).closest('section').find(".recommended-slider").trigger("prev.owl.carousel", [600]);
        });
        $(window).on("load", function () {
        ...
        $(".qtyBtn").on("click", function () {
            ...
            $button.parent().find("input").val(newVal).attr('data-value', newVal).attr('value', newVal);

            try {
                let addToCartDynamicForm = $(this).closest('.addToCartDynamicForm');
